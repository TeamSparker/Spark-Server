...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const pagedRecords = await recordDB.getDonePagedRecordsByEntryId(client, entry.entryId, lastId, size);
    ...
    return res.status(statusCode.OK).send(util.success(statusCode.OK, responseMessage.GET_THUMBNAIL_LIST_SUCCESS, data));
  } catch (error) {
    console.log(error);
